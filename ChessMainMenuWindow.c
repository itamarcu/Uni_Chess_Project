...
Window *createMainMenu() {
    Window *main_menu = createEmptyCenteredWindow(MAIN_MENU_WIDTH, MAIN_MENU_HEIGHT, MAIN_MENU_TEXTURES,
    ...
    Widget *new_game_button = createButtonSwitchBetweenWindows(main_menu, NEW_GAME_BUTTON_PATH, new_game_button_rect,
                                                               GAME_MODE);
    Widget *load_game_button = createButtonSwitchBetweenWindows(main_menu, LOAD_GAME_BUTTON_PATH, load_game_button_rect,
                                                                LOAD_GAME);
    Widget *quit_game_button = createButtonSwitchBetweenWindows(main_menu, QUIT_GAME_BUTTON_PATH, quit_game_button_rect,
                                                                QUIT);
